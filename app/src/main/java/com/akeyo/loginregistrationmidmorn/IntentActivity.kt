...
fun Intent() {
    ...
    Column(
        ...
        OutlinedButton(
            onClick = {
                val intent = android.content.Intent(android.content.Intent.ACTION_CALL, Uri.parse("tel:" + "+918511812660"))
        ...
        OutlinedButton(
            onClick = {
                ...
                val intent = android.content.Intent(android.content.Intent.ACTION_DIAL, Uri.fromParts("tel", phone, null))
...
private fun Intentprev() {
    com.akeyo.loginregistrationmidmorn.Intent()
}
